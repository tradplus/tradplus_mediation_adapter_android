...
public class AdManagerInit extends TPInitMediation {
    ...
    public synchronized static AdManagerInit getInstance() {
        if (sInstance == null) {
    ...
    public AdManagerAdRequest getAdmobAdRequest(Map<String, Object> userParams, String contentUrls, ArrayList<String> neighboringUrls) {
        ...
        return (AdManagerAdRequest) builder.addNetworkExtrasBundle(AdMobAdapter.class, networkExtrasBundle).build();
    }
