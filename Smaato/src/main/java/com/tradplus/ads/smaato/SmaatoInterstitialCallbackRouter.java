...
public class SmaatoInterstitialCallbackRouter {

    private static SmaatoInterstitialCallbackRouter instance;
    ...
    public static SmaatoInterstitialCallbackRouter getInstance() {
        if(instance == null){
            instance = new SmaatoInterstitialCallbackRouter();
        }
        return instance;
    }
