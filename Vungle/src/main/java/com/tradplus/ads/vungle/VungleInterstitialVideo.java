...
public class VungleInterstitialVideo extends TPRewardAdapter {
    ...
    private String placementId, userId, payload, appId;
    ...
    public void showAd() {
        ...
        if (!TextUtils.isEmpty(userId)) {
            ...
            Vungle.setIncentivizedFields(userId, "", "", "", "");
        }
    ...
    private final PlayAdCallback vunglePlayAdCallback = new PlayAdCallback() {
        ...
        public void onAdEnd(String id) {
            ...
            mRouter.getShowListener(id).onAdVideoEnd();
            if (hasGrantedReward || alwaysRewardUser) {
                mRouter.getShowListener(id).onReward();
            }
        ...
        public void onError(String id, VungleException exception) {
            Log.i(TAG, "onError: " + exception.getLocalizedMessage());
            if (mRouter.getListener(id) != null)
                mRouter.getListener(id).loadAdapterLoadFailed(VungleErrorUtil.getTradPlusErrorCode(SHOW_FAILED, exception));
        }
        ...
        public void onAdViewed(String id) {
            ...
            if (mRouter.getShowListener(id) != null) {
                ...
                mRouter.getShowListener(id).onAdVideoStart();
            }
        }
    };
