...
-keep public class com.applovin.mediation.nativeAds.* { public protected *; }
-keep public class com.applovin.communicator.* { public protected *; }
-keep public class com.applovin.impl.sdk.utils.CollectionUtils { public protected *; }
-keep public class com.applovin.impl.sdk.utils.JsonUtils { public protected *; }
-keep public class com.applovin.impl.sdk.utils.BundleUtils { public protected *; }
-keep public class com.applovin.impl.sdk.utils.StringUtils { public protected *; }
...
-keepclassmembers class com.applovin.sdk.AppLovinSdkSettings { private java.util.Map metaData; }
-keep class com.applovin.mediation.adapters.** { *; }
-keep class com.applovin.mediation.adapter.** { *; }
-keep class com.google.android.gms.ads.identifier.** { *; }
-keep class com.applovin.cordova.** { *; }
-keep class com.applovin.reactnative.** { *; }
